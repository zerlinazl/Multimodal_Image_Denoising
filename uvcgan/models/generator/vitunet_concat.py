...
from uvcgan.torch.layers.unet_concat        import UNet
from uvcgan.torch.select             import get_activ_layer

class ViTUNetGeneratorConcat(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.net = UNet(
            ...
            unet_downsample, unet_upsample, unet_rezero, meta
        )
