...
# class Config(ConfigBase):
    ...
    #def __init__(other things , data , other things): 

        print("\n\n\n", data, "\n") # prints None


        self.data = parse_data_config(data, data_args, image_shape)
        ...
        Config._check_deprecated_args(image_shape )

        if image_shape is not None:
            self._validate_image_shape(image_shape)

    @staticmethod
    def _check_deprecated_args(image_shape):
        if image_shape is not None:
            LOGGER.warning(
